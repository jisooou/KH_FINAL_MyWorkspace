...
CREATE SEQUENCE SEQ_NOTICE_IMG NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_BOARD_IMG NOCACHE NOCYCLE;
...
CREATE TABLE NOTICE_IMG(
    ...
    ,IMG_NAME       VARCHAR2(4000)  NOT NULL
);
